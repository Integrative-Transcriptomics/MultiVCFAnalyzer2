 ...
 *
 */
public class MultiVCFAnalyzer {//extends Application {
...
//	}
	...
	private static void loadMetadata(){
		...
		try {
			//load version
			InputStream in = MultiVCFAnalyzer.class.getResourceAsStream("/version.properties");
			properties.load(in);
			MultiVCFAnalyzer.VERSION = properties.getProperty("version");
			in.close();
			// load title
			in = MultiVCFAnalyzer.class.getResourceAsStream("/title.properties");
			properties.load(in);
			MultiVCFAnalyzer.CLASS_NAME = properties.getProperty("title");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
